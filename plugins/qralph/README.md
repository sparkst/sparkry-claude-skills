...
| Feature | Description |
|---------|-------------|
| **DEMO phase** (v6.10.1) | Present completed work to user with feedback loop (max 2 cycles) before deploy |
| **Domain personas** (v6.10.1) | Auto-suggest persona archetypes based on project keywords (SaaS, ecommerce, CLI, etc.) |
| **Evidence hardening** (v6.10.1) | Source file extension whitelist prevents URLs/IPs from bypassing evidence gate |
