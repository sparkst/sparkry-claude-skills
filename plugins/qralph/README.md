...
| Feature | Description |
|---------|-------------|
| **DEMO phase** (v6.12.0) | Present completed work to user with feedback loop (max 2 cycles) before deploy |
| **Domain personas** (v6.12.0) | Auto-suggest persona archetypes based on project keywords (SaaS, ecommerce, CLI, etc.) |
| **Evidence hardening** (v6.12.0) | Source file extension whitelist prevents URLs/IPs from bypassing evidence gate |
