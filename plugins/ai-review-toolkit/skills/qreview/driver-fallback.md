# /qreview — Legacy Python-Driver Protocol (fallback)

> **Fallback only.** As of v0.2.0, `/qreview` runs via the ultracode Workflow
> (`review-loop.workflow.js`, `rounds:1`) — see `SKILL.md`. This hand-driven
...
# /qreview -- Multi-Agent Artifact Review (legacy)
