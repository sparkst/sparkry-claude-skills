...
def _verdict_section(
    ...
    return {
        ...
        # this is the field a stored receipt can be audited against (the audit itself
        # lives in fleet#1451 REQ-CLOSURE-02, not here). Absent (None) on a run
        # recorded before the field existed — such a receipt cannot be classified.
