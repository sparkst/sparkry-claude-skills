# QRALPH v6.12.1 — Installation and Usage Guide

## What is QRALPH?

QRALPH is a deterministic 14-phase multi-agent pipeline for Claude Code (v6.12.1). It enforces proper software design process on every run — requirements decomposition, TDD, quality gates, and independent verification — so you stop babysitting AI and start shipping verified software.
